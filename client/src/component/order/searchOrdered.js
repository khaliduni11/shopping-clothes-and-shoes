//search ordered item if it is exist
//if it is not show admin/editor a message
...
class SearchOrder extends Component {
    ...
    //deliver products if it is not delivered
    handleDelivered = e => {
        const { id } = this.props;
    ...
    render() {
        const { name, currentDate, price, image, size, color, quantity, country, state, city,
            phoneNumber, street, houseNumber, deliver, username } = this.props;
        return (
            <div className="col-lg-12 col-md-6 col-sm-12 mb-2 pl-5 py-3">
                <div className="card">
                    <div className="row">
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-12">
                            ...
                            {deliver > 0 ? (
                                <button className="btn btn-success btn-sm mt-3" disabled>Delivered already</button>
                                    ...
                                    <div>
                                        <a onClick={this.handleDelivered} href="/" className="btn btn-warning btn-sm mt-3"> <span onClick={this.handleDelivered}>Deliver Now</span> </a>
                                    </div>
                                )}
                        </div>
